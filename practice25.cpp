...
void CreateDILB()
{
    ...
    printf("Infosystems CVFS : DILB created successfully\n");
}
...
{
    strcpy(bootobj.Information,"Booting process of Infosystems CVFS is done\n");
    ...
    printf("Infosystems CVFS : Auxillary data initialised successfully\n");
}
...
{
    printf("-------------------------------------------------------\n");
    printf("--------------Infosystems CVFS Help Page----------------\n");
    printf("-------------------------------------------------------\n");
...
void LsFile()
{
    ...
    printf("-------------------------------------------------------\n");
    printf("---------Infosystems CVFS File Information--------------\n");
    printf("-------------------------------------------------------\n");
...
int main()
{
    ...
    printf("-------------------------------------------------------\n");
    printf("---------Infosystems CVFS started successfully----------\n");
    printf("-------------------------------------------------------\n");
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            //Infosystems CVFS : > exit
            if(strcmp("exit",Command[0]) == 0)
            {
                printf("Thank You for using Infosystems CVFS\n");
            ...
            //Infosystems CVFS : > help
            else if(strcmp("help",Command[0]) == 0)
            {
                DisplayHelp();
            }
            //Infosystems CVFS : > clear
        ...
        {
            //Infosystems CVFS : > man ls
            if(strcmp("man",Command[0]) == 0)
            {
                ManPageDisplay(Command[1]);
            }
            //Infosystems CVFS : > Unlink Demo.txt
